...
layout = [[sg.Canvas(size=(500, 500), background_color='white', key='_canvas_'),sg.Multiline(size=(100//7, 20//7), key='_history_', font=('宋体', 12))],      
                 [sg.InputText(change_submits=True, focus=True,do_not_clear=False, size=(510//10, 20//7), key='_command_', font=('宋体', 16)),], 
...
while True:
    ...
    if event=="_command_" and values['_command_']=="" : #回车
        print('return')
    elif event == "_command_":
